...
import com.punchlab.punchclassifier.data.*
...
class MoveNet(private val interpreter: Interpreter, private var gpuDelegate: GpuDelegate?) :
     ...
     */
    private fun processInputImage(detectBitmap: Bitmap,
                                  inputWidth: Int,
                                  inputHeight: Int
    ): TensorImage {
    ...
    private fun determineTorsoAndBodyDistances(
        keyPoints: List<KeyPoint>,
        targetKeyPoints: MutableList<KeyPoint>,
